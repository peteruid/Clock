...
struct Theme: Identifiable, Equatable {
    ...
    static let all: [Theme] = [
        ...
        Theme(id: "widget",      name: "Widget",      cardColor: Color(.displayP3, red: 31/255, green: 36/255, blue: 40/255), textColor: .white, separatorColor: Color(.displayP3, red: 20/255, green: 24/255, blue: 27/255)),
    ]
